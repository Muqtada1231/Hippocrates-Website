(function () {
  ...
  var PEOPLE = [
    { id: 'sajad', name: 'د. سجاد عبد العزيز خليفة', nameEn: 'Sajad Abdul Aziz Khalifa', photo: 'assets/lecturers/sajad-abdul-aziz-khalifa.png',
      subjects: ['Anatomy'], role: 'محاضر — التشريح للمرحلة الأولى', gpa: '78.38',
      bio: ['من أوائل خريجي طب النهرين بتسلسل 34', 'المعدل التراكمي: 78.38', 'حاصل على درجة الامتياز في مادة التشريح مع اهتمام وشغف خاص بالمادة', 'خبرة في تدريس مادة التشريح لأكثر من 30 ساعة تدريسية مجانية حققت أكثر من ربع مليون مشاهدة', 'مسيرة أكاديمية متميزة خلال سنوات الكلية ومشارك في أنشطة وفعاليات الكلية', 'مسؤول عن شرح مادة Anatomy للمرحلة الأولى في منصة Hippocrates'] },
